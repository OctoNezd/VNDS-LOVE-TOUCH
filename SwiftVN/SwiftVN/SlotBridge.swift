...
//
//    swiftvn_request_slot(dirPath, isSave)
//      Presents the SwiftUI slot-picker sheet and returns immediately.
//      The game loop must poll swiftvn_poll_slot_result() each frame.
//
//    swiftvn_poll_slot_result(outSlot) -> Bool
...
@_silgen_name("swiftvn_request_slot")
public func swiftvn_request_slot(_ dirPath: UnsafePointer<CChar>,
                                    _ isSave: Bool) {
...
/// Returns false while the sheet is still open.
@_silgen_name("swiftvn_poll_slot_result")
public func swiftvn_poll_slot_result(_ outSlot: UnsafeMutablePointer<Int32>) -> Bool {
